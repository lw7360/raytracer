...
// Vector class from [vector.js](https://github.com/evanw/lightgl.js/blob/master/src/vector.js)
...
// A Camera class 
function Camera(ex, ey, ez, llx, lly, llz, lrx, lry, lrz, ulx, uly, ulz, urx, ury, urz) {
